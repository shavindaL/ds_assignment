        ...
        <section className="h-screen">
          <div className="h-full">
            <div
              ...
              <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12" style={{ position: "absolute", top: "180px", right: "50px" }}>
                <form>
                  <div
                  ...
                  <div className="relative mb-6" data-te-input-wrapper-init>
                    <input
                      type="text"
                      style={{ border: "1px", borderStyle: "solid", height: "50px", padding: "5px" }}
