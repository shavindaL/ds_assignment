...
export default function Login() {
  ...
  const { slogin, serror } = sellerLogin();

  const handlesubmit = async (e) => {
    e.preventDefault();

    if (document.getElementById("exampleCheck212").checked) {
  ...
  console.log("check box here", checkBox);
        ...
        <div className="h-full">
          <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
            <div className="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
              <img
                src="https://i.ibb.co/r0CM1md/pexels-alesia-croped.png"
                className="w-full"
                alt="Sample image"
              />
            </div>
            <div
              ...
              style={{ position: "absolute", top: "180px", right: "50px" }}
            >
              <form onSubmit={handlesubmit}>
                ...
                {error && <div class="text-danger" mt-10 mb-10>{error}</div>}
                <div className="relative mb-6">
                  <input
                    type="password"
