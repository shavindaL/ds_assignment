    ...
    return (
        ...
        <>
            ...
            <nav
                ...
                <h4 className="font-roboto text-white text-[24px] flex justify-center mb-2 font-medium leading-[1.2]">Ann Smith</h4>
                <br /><br />
                    ...
                    <ul
                        ...
                        <li className="relative">
                            ...
                            >
                                ...
                                <span
                                    className="mr-4 [&>svg]:h-3.5 [&>svg]:w-[18px] [&svg]:h-[18px]">
