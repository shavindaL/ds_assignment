export default function Notifications() {
    return (
        ...
        <>
            <center>
                <div className="flex justify-center border-b-[1px] border-[#95DE64] pb-[10px] pt-[10px] pl-[30px] pr-[30px]
                w-[655px] h-[52px]">
                    <button className="font-roboto font-[500] text-[24px] text-green-8 ml-[92px]
                    focus:underline">Today</button>
                    <button className="font-roboto font-[500] text-[24px] text-[#D9D9D9] ml-[92px] focus:underline">Previous</button>
                    <button className="font-roboto font-[500] text-[20px] text-[#FF0000] ml-[92px]">clear all</button>
                </div>
            </center>
            ...
            <center>
                <div id="accordionExample"
                    className="w-[655px] h-[72px] rounded-[5px] mt-[35px] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
                    <div
                        ...
                        <div
                            ...
                            <div class="py-4 px-5 flex justify-center">
                                <div className="flex">
                                    <p className="font-roboto font-[700] text-[14px]">Customer Name: &nbsp;</p>
                                    <p className="font-roboto font-[400] text-[14px]">John Smith</p>
                                </div>

                                <p className="pl-[151px]"></p>

                                <div className="flex">
                                    <p className="font-roboto font-[700] text-[14px]">Ordered Date: &nbsp;</p>
                                    <p className="font-roboto font-[400] text-[14px]">27/02/2023</p>
                                </div>
                            ...
                            <div class="py-4 px-5 flex justify-center mb-[20px]">
                                ...
                                <div className="flex">
                                    <p className="font-roboto font-[700] text-[14px]">Order Details: &nbsp;</p>
                                ...
                                <div className="flex  relative left-[118px]">
                                    <p className="font-roboto font-[700] text-[14px]">Total Cost: &nbsp;</p>
                                    <p className="font-roboto font-[400] text-[14px]">LKR 4000</p>
                                </div>
